...
## 1. Detect / Ask The Environment & Template Strategy
...
- **Template Choice**: If building a new system:
  1. *Build upon template (Fork & Update)*
  2. *Create from scratch with template in mind (Reference-Informed Scratch Build)*
  3. *Custom Pure Architecture*
...
1. **Clarify** the idea and template choice with the user (see `../user/user_input.md`).
