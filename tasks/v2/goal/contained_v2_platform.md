...
- [ ] `base/01_frontend_granular_realtime.md` — Decoupled React+Vite frontend with Zustand and WebSockets/SSE.
...
- [ ] `base/04_agent_management_crud.md` — APIs and UI for Agent CRUD.
