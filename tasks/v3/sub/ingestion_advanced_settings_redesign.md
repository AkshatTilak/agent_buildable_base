...
## Actionable Steps
- [x] In `IngestionPanel.tsx`, refactor the monolithic advanced parameters block into a tabbed layout:
...
- [x] Style tabs according to the V3 design system: active tab highlight border, soft accent background.
- [x] Save strategy preferences to `ingestionSlice` so selections persist across component remounts.
- [x] Add tooltips/info icons explaining each strategy and parameter option.
