...
## Actionable Steps
- [ ] Create `infrastructure/docker-compose.dev.yml` override file:
...
- [ ] Provide command instructions for launching dev mode: `docker compose -f infrastructure/docker-compose.yml -f infrastructure/docker-compose.dev.yml up`.
