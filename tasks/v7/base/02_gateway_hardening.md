...
## Associated Subtasks
- `[ ]` `tasks/v7/sub/sub_02_01_health_endpoint_fix.md`
- `[ ]` `tasks/v7/sub/sub_02_02_remove_silent_fallbacks.md`
- `[ ]` `tasks/v7/sub/sub_02_03_proxy_json_error_handling.md`
- `[ ]` `tasks/v7/sub/sub_02_04_logger_traceback_visibility.md`
