...
- Modify `gateway/core/setup.py` (or equivalent initialization hook) to read `SUPER_ADMIN_EMAIL`, `SUPER_ADMIN_PASSWORD` and optionally `TEST_USER` credentials from `.env`.
